...
{
    string InputFile  = "/work/halld2/home/boyu/src_analysis/selection/output/test/flattree_phi_c_2H_kpkmmissd_1_sim.root";
    ...
    .Define("kp_as_pip_p4_true",    "TLorentzVector(kp_p4_true.Vect(), TMath::Sqrt(kp_p4_true.P()*kp_p4_true.P() + mass_pion*mass_pion))")
    ...
    .Define("km_as_pim_p4_true",    "TLorentzVector(km_p4_true.Vect(), TMath::Sqrt(km_p4_true.P()*km_p4_true.P() + mass_pion*mass_pion))")
    ...
    .Define("beam_p4com_true",      "boost_lorentz_vector(beam_p4_true, -(beam_p4_true + deuteron_p4).BoostVector())")
    ...
    .Define("yphi_true",            "minust_true/(2*mass_deuteron*(beam_p4_true.E()-phi_p4_true.E()))")
    ...
    .Define("deltaE_true",          "(pow(sqrts_true, 2) - pow(mass_deuteron, 2) + pow(mass_phi, 2)) / (2.0 * sqrts_true) - phi_p4com_true.E()")
    ;
