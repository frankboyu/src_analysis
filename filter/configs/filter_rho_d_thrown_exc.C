...
void filter_rho_d_thrown_exc(string reaction, string output_mode)
{
    ...
    if (output_mode == "tree" || output_mode == "both")
    {
        ...
        string output_treefile_name = Form("/work/halld2/home/boyu/src_analysis/filter/output/filteredtree_rho_d_thrown_exc_%s.root",reaction.c_str());
    ...
    if (output_mode == "hist" || output_mode == "both")
    {
        ...
        string output_histfile_name = Form("/work/halld2/home/boyu/src_analysis/filter/output/filteredhist_rho_d_thrown_exc_%s.root",reaction.c_str());
