...
void filter_rho_d_recon(string reaction_name, string input_mode, string output_mode)
{
    string input_name   = Form("/work/halld2/home/boyu/src_analysis/selection/output/selectedtree_rho_d_recon_%s_%s.root",reaction_name.c_str(), input_mode.c_str());
    string hist_name    = Form("/work/halld2/home/boyu/src_analysis/filter/output/filteredhist_rho_d_recon_%s_%s.root",reaction_name.c_str(), input_mode.c_str());
    string tree_name    = Form("/work/halld2/home/boyu/src_analysis/filter/output/filteredtree_rho_d_recon_%s_%s.root",reaction_name.c_str(), input_mode.c_str());
    ...
    .Define("struck_p4_meas",               "pip_p4_meas + pim_p4_meas + d_p4_meas - beam_p4_meas")
    .Define("struck_p4_kin",                "pip_p4_kin + pim_p4_kin + d_p4_kin - beam_p4_kin")
    .Define("struck_p4_truth",              "pip_p4_truth + pim_p4_truth + d_p4_truth - beam_p4_truth")
    ...
    .Define("miss_p4_meas",                 "beam_p4_meas + target_p4 - pip_p4_meas - pim_p4_meas - d_p4_meas")
    .Define("miss_p4_kin",                  "beam_p4_kin + target_p4 - pip_p4_kin - pim_p4_kin - d_p4_kin")
    .Define("miss_p4_truth",                "beam_p4_truth + target_p4 - pip_p4_truth - pim_p4_truth - d_p4_truth")
    ...
    auto rdf_dEdxCut            = rdf_NoCut.Filter("(d_dedx_cdc_keV_per_cm > (TMath::Exp(-4.5*d_momentum_meas+5.0)+2))");
    ...
    auto rdf_RhoMassCut         = rdf_PIDFOMCut.Filter("(rho_mass_kin > 0.5) && (rho_mass_kin < 1.0)");
