...
void filter_rho_d_recon(string reaction_name, string output_mode)
{
    string input_name   = Form("/work/halld2/home/boyu/src_analysis/selection/output/selectedtree_rho_d_recon_%s.root",reaction_name.c_str());
    string hist_name    = Form("/work/halld2/home/boyu/src_analysis/filter/output/filteredhist_rho_d_recon_%s.root",reaction_name.c_str());
    string tree_name    = Form("/work/halld2/home/boyu/src_analysis/filter/output/filteredtree_rho_d_recon_%s.root",reaction_name.c_str());
