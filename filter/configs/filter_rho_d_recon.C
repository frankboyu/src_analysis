...
void filter_rho_d_recon(string reaction, string output_mode)
{
    cout << "Reading input files...\n";
    string input_treefile_name  = Form("/work/halld2/home/boyu/src_analysis/selection/output/selectedtree_rho_d_recon_%s.root",reaction.c_str());
    string input_tree_name  = "selectedtree_rho_d_recon";
    ...
    .Define("rho_proxymass_meas",               "TMath::Sqrt(rho_p4_meas.Minus()*(2*beam_energy_meas + mass_target - d_p4_meas.Plus() - (TMath::Sq(mass_missing) + (rho_p4_meas + d_p4_meas).Perp2())/(mass_target - (rho_p4_meas + d_p4_meas).Minus())) - rho_p4_meas.Perp2())")
    .Define("rho_proxymass_kin",                "TMath::Sqrt(rho_p4_kin.Minus()*(2*beam_energy_kin + mass_target - d_p4_kin.Plus() - (TMath::Sq(mass_missing) + (rho_p4_kin + d_p4_kin).Perp2())/(mass_target - (rho_p4_kin + d_p4_kin).Minus())) - rho_p4_kin.Perp2())")
    ...
    .Define("miss_p4_meas",                     "beam_p4_meas + TLorentzVector(0, 0, 0, mass_target) - rho_p4_meas - d_p4_meas")
    .Define("miss_p4_kin",                      "beam_p4_kin + TLorentzVector(0, 0, 0, mass_target) - rho_p4_kin - d_p4_kin")
    ...
    .Define("total_final_p4_meas",              "rho_p4_meas + d_p4_meas")
    .Define("total_final_p4_kin",               "rho_p4_kin + d_p4_kin")
    ...
    .Define("rho_p4_com_meas",                  "boost_lorentz_vector(rho_p4_meas, -total_final_p4_meas.BoostVector())")
    .Define("rho_p4_com_kin",                   "boost_lorentz_vector(rho_p4_kin, -total_final_p4_kin.BoostVector())")
    ...
    .Define("y_x3_com_meas",                    "beam_p4_com_meas.Vect().Cross(rho_p4_com_meas.Vect()).Unit()")
    .Define("y_x3_com_kin",                     "beam_p4_com_kin.Vect().Cross(rho_p4_com_kin.Vect()).Unit()")
    ...
    .Define("rho_theta_com_meas",               "rho_p4_com_meas.Vect().Angle(z_x3_com_meas)*RadToDeg")
    .Define("rho_theta_com_kin",                "rho_p4_com_kin.Vect().Angle(z_x3_com_kin)*RadToDeg")
    .Define("rho_theta_com_truth",              "rho_p4_com_truth.Vect().Angle(z_x3_com_truth)*RadToDeg")

    .Define("z_x3_helicity_meas",               "rho_p4_com_meas.Vect().Unit()")
    .Define("z_x3_helicity_kin",                "rho_p4_com_kin.Vect().Unit()")
    .Define("z_x3_helicity_truth",              "rho_p4_com_truth.Vect().Unit()")
    .Define("y_x3_helicity_meas",               "beam_p4_com_meas.Vect().Cross(rho_p4_com_meas.Vect()).Unit()")
    .Define("y_x3_helicity_kin",                "beam_p4_com_kin.Vect().Cross(rho_p4_com_kin.Vect()).Unit()")
    ...
    .Define("pi_x3_helicity_meas",              "boost_lorentz_vector(pip_p4_meas, -rho_p4_meas.BoostVector()).Vect().Unit()")
    .Define("pi_x3_helicity_kin",               "boost_lorentz_vector(pip_p4_kin, -rho_p4_kin.BoostVector()).Vect().Unit()")
    .Define("pi_x3_helicity_truth",             "boost_lorentz_vector(pip_p4_truth, -rho_p4_truth.BoostVector()).Vect().Unit()")
    .Define("pip_costheta_helicity_meas",       "pi_x3_helicity_meas.Dot(z_x3_helicity_meas)")
    .Define("pip_costheta_helicity_kin",        "pi_x3_helicity_kin.Dot(z_x3_helicity_kin)")
    .Define("pip_costheta_helicity_truth",      "pi_x3_helicity_truth.Dot(z_x3_helicity_truth)")
    .Define("pip_phi_helicity_meas",            "TMath::ATan2(-x_x3_helicity_meas.Dot(pi_x3_helicity_meas.Cross(z_x3_helicity_meas)), y_x3_helicity_meas.Dot(pi_x3_helicity_meas.Cross(z_x3_helicity_meas)))*RadToDeg")
    .Define("pip_phi_helicity_kin",             "TMath::ATan2(-x_x3_helicity_kin.Dot(pi_x3_helicity_kin.Cross(z_x3_helicity_kin)), y_x3_helicity_kin.Dot(pi_x3_helicity_kin.Cross(z_x3_helicity_kin)))*RadToDeg")
    ...
    .Define("psi_helicity_meas",                "fmod(polarization_phi_com_meas-pip_phi_helicity_meas+360, 360.0) >= 180 ? fmod(polarization_phi_com_meas-pip_phi_helicity_meas+360, 360.0) - 360 : fmod(polarization_phi_com_meas-pip_phi_helicity_meas+360, 360.0)")
    .Define("psi_helicity_kin",                 "fmod(polarization_phi_com_kin-pip_phi_helicity_kin+360, 360.0) >= 180 ? fmod(polarization_phi_com_kin-pip_phi_helicity_kin+360, 360.0) - 360 : fmod(polarization_phi_com_kin-pip_phi_helicity_kin+360, 360.0)")
    ...
    auto rdf_RhoMassCut     = rdf_MissPCut.Filter("rho_mass_kin > 0.0");
    auto rdf_output         = rdf_RhoMassCut;
    RNode rdfs []           = {rdf_NoCut,   rdf_dEdxCut,    rdf_KinFitFOMCut,   rdf_PIDFOMCut,  rdf_MissPCut,   rdf_RhoMassCut};
    string labels []        = {"NoCut",     "dEdxCut",      "KinFitFOMCut",     "PIDFOMCut",    "MissPCut",     "RhoMassCut"};
    int N_filters           = sizeof(labels) / sizeof(labels[0]);

    if (output_mode == "tree" || output_mode == "both")
    {
        cout << "Saving to new tree...\n";
        string output_treefile_name = Form("/work/halld2/home/boyu/src_analysis/filter/output/filteredtree_rho_d_recon_%s.root",reaction.c_str());
        string output_tree_name = "filteredtree_rho_d_recon";
    ...
    if (output_mode == "hist" || output_mode == "both")
    {
        ...
        string output_histfile_name = Form("/work/halld2/home/boyu/src_analysis/filter/output/filteredhist_rho_d_recon_%s.root",reaction.c_str());
        ...
        for (int i = 0; i < N_filters; i++)
        {
            ...
            TH1D hist_rho_theta_com_kin                     = *rdf.Histo1D({("rho_theta_com_kin_"+ label).c_str(), ";#theta_{CM} (deg);Counts", 180, 0.0, 180.0},"rho_theta_com_kin","accidweight");
            hist_rho_theta_com_kin.Write();
            TH2D hist_minust_rho_theta_com_kin              = *rdf.Histo2D({("minust_rho_theta_com_kin_"+ label).c_str(), ";-t (GeV^{2}/c^{2});#theta_{CM} (deg)", 20, 0.0, 2.0, 40, 0.0, 40.0},"minust_kin","rho_theta_com_kin","accidweight");
            hist_minust_rho_theta_com_kin.Write();
            ...
            TH1D hist_pip_costheta_helicity_kin             = *rdf.Histo1D({("pip_costheta_helicity_kin_"+ label).c_str(), ";cos(#theta_{helicity});Counts", 10, -1.0, 1.0},"pip_costheta_helicity_kin","accidweight");
            hist_pip_costheta_helicity_kin.Write();
            TH1D hist_pip_phi_helicity_kin                  = *rdf.Histo1D({("pip_phi_helicity_kin_"+ label).c_str(), ";#phi_{helicity} (deg);Counts", 9, -180.0, 180.0},"pip_phi_helicity_kin","accidweight");
            hist_pip_phi_helicity_kin.Write();
