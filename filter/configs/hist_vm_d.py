...
plt.plot([1.005, 1.005], [0, 1400], '-', color='red')
plt.plot([1.04, 1.04], [0, 1400], '-', color='red')
plt.xlim(0.98, 1.1)
plt.ylim(0, 1400)
...
# cos(vartheta)
fig = plt.figure(figsize=(8, 6), dpi=300)
hist_data = file_data.get('AllCut/decay_costheta_helicity_kin_AllCut')
hist_sim = file_sim.get('AllCut/decay_costheta_helicity_kin_AllCut')
hist_sim.scale(0.017)
hist_data.plotPoints(label="Data", marker='o', markersize=3, linestyle='None', color='black')
hist_sim.plotPoints(label="Sim", marker='o', markersize=3, linestyle='-', color='blue')
plt.xlim(-1, 1)
...
# Phi
fig = plt.figure(figsize=(8, 6), dpi=300)
hist_data = file_data.get('AllCut/polarization_phi_com_kin_AllCut')
hist_sim = file_sim.get('AllCut/polarization_phi_com_kin_AllCut')
hist_sim.scale(0.017)
hist_data.plotPoints(label="Data", marker='o', markersize=3, linestyle='None', color='black')
hist_sim.plotPoints(label="Sim", marker='o', markersize=3, linestyle='-', color='blue')
plt.xlim(-180, 180)
...
# varphi
fig = plt.figure(figsize=(8, 6), dpi=300)
hist_data = file_data.get('AllCut/decay_phi_helicity_kin_AllCut')
hist_sim = file_sim.get('AllCut/decay_phi_helicity_kin_AllCut')
hist_sim.scale(0.017)
hist_data.plotPoints(label="Data", marker='o', markersize=3, linestyle='None', color='black')
hist_sim.plotPoints(label="Sim", marker='o', markersize=3, linestyle='-', color='blue')
plt.xlim(-180, 180)
...
# psi
fig = plt.figure(figsize=(8, 6), dpi=300)
hist_data = file_data.get('AllCut/psi_helicity_kin_AllCut')
hist_sim = file_sim.get('AllCut/psi_helicity_kin_AllCut')
hist_sim.scale(0.017)
hist_data.plotPoints(label="Data", marker='o', markersize=3, linestyle='None', color='black')
hist_sim.plotPoints(label="Sim", marker='o', markersize=3, linestyle='-', color='blue')
plt.xlim(-180, 180)
