...
void filter_omega_d_recon(string reaction, string output_mode)
{
    ...
    .Define("pi_x3_helicity_meas",              "boost_lorentz_vector(pip_p4_meas, -omega_p4_meas.BoostVector()).Vect().Unit()")
    .Define("pi_x3_helicity_kin",               "boost_lorentz_vector(pip_p4_kin, -omega_p4_kin.BoostVector()).Vect().Unit()")
