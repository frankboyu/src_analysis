...
void filter_phi_d_recon(string reaction, string output_mode)
{
    ...
    .Define("kp_in_fdc_meas",               "accidweight*(kp_dedx_fdc > 0.0 && kp_dedx_cdc == 0.0)")
    .Define("kp_in_cdc_meas",               "accidweight*(kp_dedx_cdc > 0.0 && kp_dedx_fdc == 0.0)")
    .Define("kp_in_fdc_cdc_meas",           "accidweight*(kp_dedx_fdc > 0.0 && kp_dedx_cdc > 0.0)")
    .Define("kp_in_neither_meas",           "accidweight*(kp_dedx_fdc == 0.0 && kp_dedx_cdc == 0.0)")
    .Define("kp_dedx_fdc_keV_per_cm_meas",  "kp_dedx_fdc*1e6")
    .Define("kp_dedx_cdc_keV_per_cm_meas",  "kp_dedx_cdc*1e6")
    .Define("kp_dedx_st_keV_per_cm_meas",   "kp_dedx_st*1e6")
    .Define("kp_dedx_tof_keV_per_cm_meas",  "kp_dedx_tof*1e6")
    ...
    .Define("km_in_fdc_meas",               "accidweight*(km_dedx_fdc > 0.0 && km_dedx_cdc == 0.0)")
    .Define("km_in_cdc_meas",               "accidweight*(km_dedx_cdc > 0.0 && km_dedx_fdc == 0.0)")
    .Define("km_in_fdc_cdc_meas",           "accidweight*(km_dedx_fdc > 0.0 && km_dedx_cdc > 0.0)")
    .Define("km_in_neither_meas",           "accidweight*(km_dedx_fdc == 0.0 && km_dedx_cdc == 0.0)")
    .Define("km_dedx_fdc_keV_per_cm_meas",  "km_dedx_fdc*1e6")
    .Define("km_dedx_cdc_keV_per_cm_meas",  "km_dedx_cdc*1e6")
    .Define("km_dedx_st_keV_per_cm_meas",   "km_dedx_st*1e6")
    .Define("km_dedx_tof_keV_per_cm_meas",  "km_dedx_tof*1e6")
    ...
    .Define("total_initial_p4_meas",        "beam_p4_meas + target_p4")
    .Define("total_initial_p4_kin",         "beam_p4_kin + target_p4")
    .Define("total_initial_p4_truth",       "beam_p4_truth + target_p4")
    ...
    .Define("epsilon_p3_com",               "TVector3(TMath::Cos(polarization_angle/RadToDeg), TMath::Sin(polarization_angle/RadToDeg), 0)")
    ...
    .Define("phi_p4_com_meas",              "boost_lorentz_vector(phi_p4_meas, -total_final_p4_meas.BoostVector())")
    .Define("phi_p4_com_kin",               "boost_lorentz_vector(phi_p4_kin, -total_final_p4_kin.BoostVector())")
    .Define("phi_p4_com_truth",             "boost_lorentz_vector(phi_p4_truth, -total_final_p4_truth.BoostVector())")
    .Define("z_p3_com_meas",                "beam_p4_com_meas.Vect().Unit()")
    .Define("z_p3_com_kin",                 "beam_p4_com_kin.Vect().Unit()")
    .Define("z_p3_com_truth",               "beam_p4_com_truth.Vect().Unit()")
    .Define("y_p3_com_meas",                "beam_p4_com_meas.Vect().Cross(phi_p4_com_meas.Vect()).Unit()")
    .Define("y_p3_com_kin",                 "beam_p4_com_kin.Vect().Cross(phi_p4_com_kin.Vect()).Unit()")
    .Define("y_p3_com_truth",               "beam_p4_com_truth.Vect().Cross(phi_p4_com_truth.Vect()).Unit()")
    .Define("x_p3_com_meas",                "y_p3_com_meas.Cross(z_p3_com_meas).Unit()")
    .Define("x_p3_com_kin",                 "y_p3_com_kin.Cross(z_p3_com_kin).Unit()")
    .Define("x_p3_com_truth",               "y_p3_com_truth.Cross(z_p3_com_truth).Unit()")
    .Define("phi_com_meas",                 "TMath::ATan2(-x_p3_com_meas.Dot(epsilon_p3_com.Cross(z_p3_com_meas)), y_p3_com_meas.Dot(epsilon_p3_com.Cross(z_p3_com_meas)))*RadToDeg")
    .Define("phi_com_kin",                  "TMath::ATan2(-x_p3_com_kin.Dot(epsilon_p3_com.Cross(z_p3_com_kin)), y_p3_com_kin.Dot(epsilon_p3_com.Cross(z_p3_com_kin)))*RadToDeg")
    .Define("phi_com_truth",                "TMath::ATan2(-x_p3_com_truth.Dot(epsilon_p3_com.Cross(z_p3_com_truth)), y_p3_com_truth.Dot(epsilon_p3_com.Cross(z_p3_com_truth)))*RadToDeg")
    .Define("scatter_theta_com_meas",       "phi_p4_com_meas.Vect().Angle(z_p3_com_meas)*RadToDeg")
    .Define("scatter_theta_com_kin",        "phi_p4_com_kin.Vect().Angle(z_p3_com_kin)*RadToDeg")
    .Define("scatter_theta_com_truth",      "phi_p4_com_truth.Vect().Angle(z_p3_com_truth)*RadToDeg")

    .Define("z_p3_helicity_meas",           "phi_p4_com_meas.Vect().Unit()")
    .Define("z_p3_helicity_kin",            "phi_p4_com_kin.Vect().Unit()")
    .Define("z_p3_helicity_truth",          "phi_p4_com_truth.Vect().Unit()")
    .Define("y_p3_helicity_meas",           "beam_p4_com_meas.Vect().Cross(phi_p4_com_meas.Vect()).Unit()")
    .Define("y_p3_helicity_kin",            "beam_p4_com_kin.Vect().Cross(phi_p4_com_kin.Vect()).Unit()")
    .Define("y_p3_helicity_truth",          "beam_p4_com_truth.Vect().Cross(phi_p4_com_truth.Vect()).Unit()")
    .Define("x_p3_helicity_meas",           "y_p3_helicity_meas.Cross(z_p3_helicity_meas).Unit()")
    .Define("x_p3_helicity_kin",            "y_p3_helicity_kin.Cross(z_p3_helicity_kin).Unit()")
    .Define("x_p3_helicity_truth",          "y_p3_helicity_truth.Cross(z_p3_helicity_truth).Unit()")
    .Define("pi_p3_helicity_meas",          "boost_lorentz_vector(kp_p4_meas, -phi_p4_meas.BoostVector()).Vect().Unit()")
    .Define("pi_p3_helicity_kin",           "boost_lorentz_vector(kp_p4_kin, -phi_p4_kin.BoostVector()).Vect().Unit()")
    .Define("pi_p3_helicity_truth",         "boost_lorentz_vector(kp_p4_truth, -phi_p4_truth.BoostVector()).Vect().Unit()")
    .Define("costheta_helicity_meas",       "pi_p3_helicity_meas.Dot(z_p3_helicity_meas)")
    .Define("costheta_helicity_kin",        "pi_p3_helicity_kin.Dot(z_p3_helicity_kin)")
    .Define("costheta_helicity_truth",      "pi_p3_helicity_truth.Dot(z_p3_helicity_truth)")
    .Define("phi_helicity_meas",            "TMath::ATan2(-x_p3_helicity_meas.Dot(pi_p3_helicity_meas.Cross(z_p3_helicity_meas)), y_p3_helicity_meas.Dot(pi_p3_helicity_meas.Cross(z_p3_helicity_meas)))*RadToDeg")
    .Define("phi_helicity_kin",             "TMath::ATan2(-x_p3_helicity_kin.Dot(pi_p3_helicity_kin.Cross(z_p3_helicity_kin)), y_p3_helicity_kin.Dot(pi_p3_helicity_kin.Cross(z_p3_helicity_kin)))*RadToDeg")
    .Define("phi_helicity_truth",           "TMath::ATan2(-x_p3_helicity_truth.Dot(pi_p3_helicity_truth.Cross(z_p3_helicity_truth)), y_p3_helicity_truth.Dot(pi_p3_helicity_truth.Cross(z_p3_helicity_truth)))*RadToDeg")
    .Define("psi_helicity_meas",            "phi_com_meas-phi_helicity_meas")
    .Define("psi_helicity_kin",             "phi_com_kin-phi_helicity_kin")
    .Define("psi_helicity_truth",           "phi_com_truth-phi_helicity_truth")
    ;
    ...
    auto rdf_PhiMassCut     = rdf_MissPCut.Filter("phi_mass_kin < 1.1");
    ...
    if (output_mode == "hist" || output_mode == "both")
    {
        ...
        for (int i = 0; i < N_filters; i++)
        {
            ...
            TH2D hist_kp_dEdx_cdc_kin                   = *rdf.Histo2D({("kp_dEdx_cdc_kin_"+ label).c_str(), ";p (GeV/c);dE/dx (keV/cm)", 100, 0.0, 10.0, 100, 0.0, 40},"kp_momentum_kin","kp_dedx_cdc_keV_per_cm_meas","accidweight");
            hist_kp_dEdx_cdc_kin.Write();
            TH2D hist_kp_dEdx_fdc_kin                   = *rdf.Histo2D({("kp_dEdx_fdc_kin_"+ label).c_str(), ";p (GeV/c);dE/dx (keV/cm)", 100, 0.0, 10.0, 100, 0.0, 40},"kp_momentum_kin","kp_dedx_fdc_keV_per_cm_meas","accidweight");
            hist_kp_dEdx_fdc_kin.Write();
            TH2D hist_kp_dEdx_tof_kin                   = *rdf.Histo2D({("kp_dEdx_tof_kin_"+ label).c_str(), ";p (GeV/c);dE/dx (keV/cm)", 100, 0.0, 10.0, 100, 0.0, 40},"kp_momentum_kin","kp_dedx_tof_keV_per_cm_meas","accidweight");
            hist_kp_dEdx_tof_kin.Write();
            TH2D hist_kp_dEdx_st_kin                    = *rdf.Histo2D({("kp_dEdx_st_kin_"+ label).c_str(), ";p (GeV/c);dE/dx (keV/cm)", 100, 0.0, 10.0, 100, 0.0, 40},"kp_momentum_kin","kp_dedx_st_keV_per_cm_meas","accidweight");
            hist_kp_dEdx_st_kin.Write();
            TH1D hist_kp_DeltaT_kin                     = *rdf.Histo1D({("kp_DeltaT_kin_"+ label).c_str(), ";#Delta t_{K^{+}} (ns);Counts", 100, -5.0, 5.0},"kp_DeltaT_kin","accidweight");
            ...
            TH2D hist_km_dEdx_cdc_kin                   = *rdf.Histo2D({("km_dEdx_cdc_kin_"+ label).c_str(), ";p (GeV/c);dE/dx (keV/cm)", 100, 0.0, 10.0, 100, 0.0, 40},"km_momentum_kin","km_dedx_cdc_keV_per_cm_meas","accidweight");
            hist_km_dEdx_cdc_kin.Write();
            TH2D hist_km_dEdx_fdc_kin                   = *rdf.Histo2D({("km_dEdx_fdc_kin_"+ label).c_str(), ";p (GeV/c);dE/dx (keV/cm)", 100, 0.0, 10.0, 100, 0.0, 40},"km_momentum_kin","km_dedx_fdc_keV_per_cm_meas","accidweight");
            hist_km_dEdx_fdc_kin.Write();
            TH2D hist_km_dEdx_tof_kin                   = *rdf.Histo2D({("km_dEdx_tof_kin_"+ label).c_str(), ";p (GeV/c);dE/dx (keV/cm)", 100, 0.0, 10.0, 100, 0.0, 40},"km_momentum_kin","km_dedx_tof_keV_per_cm_meas","accidweight");
            hist_km_dEdx_tof_kin.Write();
            TH2D hist_km_dEdx_st_kin                    = *rdf.Histo2D({("km_dEdx_st_kin_"+ label).c_str(), ";p (GeV/c);dE/dx (keV/cm)", 100, 0.0, 10.0, 100, 0.0, 40},"km_momentum_kin","km_dedx_st_keV_per_cm_meas","accidweight");
            hist_km_dEdx_st_kin.Write();
            TH1D hist_km_DeltaT_kin                     = *rdf.Histo1D({("km_DeltaT_kin_"+ label).c_str(), ";#Delta t_{K^{-}} (ns);Counts", 100, -5.0, 5.0},"km_DeltaT_kin","accidweight");
            ...
            TH1D hist_phi_proxymass_kin                 = *rdf.Histo1D({("phi_proxymass_kin_"+ label).c_str(), ";m^{proxy}_{K^{+}K^{-}} (GeV/c^{2});Counts", 400, 0.9, 1.3},"phi_proxymass_kin","accidweight");
            hist_phi_proxymass_kin.Write();
            TH1D hist_phi_proxymass_meas                = *rdf.Histo1D({("phi_proxymass_meas_"+ label).c_str(), ";m^{proxy}_{K^{+}K^{-}} (GeV/c^{2});Counts", 400, 0.9, 1.3},"phi_proxymass_meas","accidweight");
            ...
            TH1D hist_miss_pminus_kin                   = *rdf.Histo1D({("miss_pminus_kin_"+ label).c_str(), ";P_{miss}^{-} (GeV/c);Counts", 100, 0.0, 10.0},"miss_pminus_kin","accidweight");
            hist_miss_pminus_kin.Write();
            TH1D hist_miss_pminus_meas                  = *rdf.Histo1D({("miss_pminus_meas_"+ label).c_str(), ";P_{miss}^{-} (GeV/c);Counts", 100, 0.0, 10.0},"miss_pminus_meas","accidweight");
            ...
            TH2D hist_miss_momentum_pminus_kin          = *rdf.Histo2D({("miss_momentum_pminus_kin_"+ label).c_str(), ";P_{miss} (GeV/c);P_{miss}^{-} (GeV/c)", 200, 0.0, 2.0, 100, 0.0, 10.0},"miss_momentum_kin","miss_pminus_kin","accidweight");
            hist_miss_momentum_pminus_kin.Write();
            TH2D hist_miss_momentum_pminus_meas         = *rdf.Histo2D({("miss_momentum_pminus_meas_"+ label).c_str(), ";P_{miss} (GeV/c);P_{miss}^{-} (GeV/c)", 200, 0.0, 2.0, 100, 0.0, 10.0},"miss_momentum_meas","miss_pminus_meas","accidweight");
            hist_miss_momentum_pminus_meas.Write();
            TH2D hist_miss_momentum_energy_balance_kin  = *rdf.Histo2D({("miss_momentum_energy_kin_"+ label).c_str(), ";P_{miss} (GeV/c);E_{miss} (GeV)", 200, 0.0, 2.0, 400, -4.0, 4.0},"miss_momentum_kin","miss_energy_balance_kin","accidweight");
            hist_miss_momentum_energy_balance_kin.Write();
            TH2D hist_miss_momentum_energy_balance_meas = *rdf.Histo2D({("miss_momentum_energy_meas_"+ label).c_str(), ";P_{miss} (GeV/c);E_{miss} (GeV)", 200, 0.0, 2.0, 400, -4.0, 4.0},"miss_momentum_meas","miss_energy_balance_meas","accidweight");
            hist_miss_momentum_energy_balance_meas.Write();
            ...
            TH1D hist_rho_mass_kin                      = *rdf.Histo1D({("rho_mass_kin_"+ label).c_str(), ";m_{#pi^{+}#pi^{-}} (GeV/c^{2});Counts", 100, 0.0, 1.0},"rho_mass_kin","accidweight");
            ...
            TH1D hist_phi_com_kin                       = *rdf.Histo1D({("phi_com_kin_"+ label).c_str(), ";#phi_{com} (deg);Counts", 9, -180, 180.0},"phi_com_kin","accidweight");
            hist_phi_com_kin.Write();
            ...
            TH1D hist_psi_helicity_kin                  = *rdf.Histo1D({("psi_helicity_kin_"+ label).c_str(), ";#psi_{helicity} (deg);Counts", 9, -360.0, 360.0},"psi_helicity_kin","accidweight");
            ...
            if (reaction.find("sim") != string::npos)
            {
                ...
                TH2D hist_minust_scatter_theta_com_truth    = *rdf.Histo2D({("minust_scatter_theta_com_truth_"+ label).c_str(), ";-t (GeV^{2}/c^{2});#theta_{CM} (deg)", 200, 0.0, 20.0, 180, 0.0, 180.0},"minust_truth","scatter_theta_com_truth");
