...
void filter_phi_d_recon(string reaction, string output_mode)
{
    ...
    .Define("phi_theta_com_meas",               "phi_p4_com_meas.Vect().Angle(z_x3_com_meas)*RadToDeg")
    .Define("phi_theta_com_kin",                "phi_p4_com_kin.Vect().Angle(z_x3_com_kin)*RadToDeg")
    .Define("phi_theta_com_truth",              "phi_p4_com_truth.Vect().Angle(z_x3_com_truth)*RadToDeg")
    ...
    .Define("pi_x3_helicity_meas",              "boost_lorentz_vector(kp_p4_meas, -phi_p4_meas.BoostVector()).Vect().Unit()")
    .Define("pi_x3_helicity_kin",               "boost_lorentz_vector(kp_p4_kin, -phi_p4_kin.BoostVector()).Vect().Unit()")
    .Define("pi_x3_helicity_truth",             "boost_lorentz_vector(kp_p4_truth, -phi_p4_truth.BoostVector()).Vect().Unit()")
    .Define("kp_costheta_helicity_meas",        "pi_x3_helicity_meas.Dot(z_x3_helicity_meas)")
    .Define("kp_costheta_helicity_kin",         "pi_x3_helicity_kin.Dot(z_x3_helicity_kin)")
    .Define("kp_costheta_helicity_truth",       "pi_x3_helicity_truth.Dot(z_x3_helicity_truth)")
    .Define("kp_phi_helicity_meas",             "TMath::ATan2(-x_x3_helicity_meas.Dot(pi_x3_helicity_meas.Cross(z_x3_helicity_meas)), y_x3_helicity_meas.Dot(pi_x3_helicity_meas.Cross(z_x3_helicity_meas)))*RadToDeg")
    .Define("kp_phi_helicity_kin",              "TMath::ATan2(-x_x3_helicity_kin.Dot(pi_x3_helicity_kin.Cross(z_x3_helicity_kin)), y_x3_helicity_kin.Dot(pi_x3_helicity_kin.Cross(z_x3_helicity_kin)))*RadToDeg")
    .Define("kp_phi_helicity_truth",            "TMath::ATan2(-x_x3_helicity_truth.Dot(pi_x3_helicity_truth.Cross(z_x3_helicity_truth)), y_x3_helicity_truth.Dot(pi_x3_helicity_truth.Cross(z_x3_helicity_truth)))*RadToDeg")
    .Define("psi_helicity_meas",                "fmod(polarization_phi_com_meas-kp_phi_helicity_meas+360, 360.0) >= 180 ? fmod(polarization_phi_com_meas-kp_phi_helicity_meas+360, 360.0) - 360 : fmod(polarization_phi_com_meas-kp_phi_helicity_meas+360, 360.0)")
    .Define("psi_helicity_kin",                 "fmod(polarization_phi_com_kin-kp_phi_helicity_kin+360, 360.0) >= 180 ? fmod(polarization_phi_com_kin-kp_phi_helicity_kin+360, 360.0) - 360 : fmod(polarization_phi_com_kin-kp_phi_helicity_kin+360, 360.0)")
    .Define("psi_helicity_truth",               "fmod(polarization_phi_com_truth-kp_phi_helicity_truth+360, 360.0) >= 180 ? fmod(polarization_phi_com_truth-kp_phi_helicity_truth+360, 360.0) - 360 : fmod(polarization_phi_com_truth-kp_phi_helicity_truth+360, 360.0)")
    ;
    ...
    if (output_mode == "hist" || output_mode == "both")
    {
        ...
        for (int i = 0; i < N_filters; i++)
        {
            ...
            TH1D hist_kp_DeltaT_kin                         = *rdf.Histo1D({("kp_DeltaT_kin_"+ label).c_str(), ";#Delta t_{K^{+}} (ns);Counts", 100, -2.0, 2.0},"kp_DeltaT_kin","accidweight");
            ...
            TH1D hist_km_DeltaT_kin                         = *rdf.Histo1D({("km_DeltaT_kin_"+ label).c_str(), ";#Delta t_{K^{-}} (ns);Counts", 100, -2.0, 2.0},"km_DeltaT_kin","accidweight");
            ...
            TH2D hist_phi_mass_kin_meas                     = *rdf.Histo2D({("phi_mass_kin_meas_"+ label).c_str(), ";m^{kin}_{K^{+}K^{-}} (GeV/c);m^{meas}_{K^{+}K^{-}} (GeV/c^{2})", 400, 0.9, 1.3, 400, 0.9, 1.3},"phi_mass_kin","phi_mass_meas","accidweight");
            hist_phi_mass_kin_meas.Write();
            TH2D hist_phi_kinematics_kin                    = *rdf.Histo2D({("phi_kinematics_kin_"+ label).c_str(), ";p (GeV/c);#theta (deg)", 110, 0.0, 11.0, 180, 0.0, 180.0},"phi_momentum_kin","phi_theta_kin","accidweight");
            ...
            TH2D hist_miss_energy_phi_mass_meas             = *rdf.Histo2D({("miss_energy_phi_mass_meas_"+ label).c_str(), ";E_{miss} - m_{A-2} (GeV);m_{K^{+}K^{-}} (GeV/c)", 300, -3.0, 3.0, 400, 0.9, 1.3},"miss_energy_balance_meas","phi_mass_meas","accidweight");
            ...
            hist_yphi_kin.Write();
            TH1D hist_yphi_meas                             = *rdf.Histo1D({("yphi_meas_"+ label).c_str(), ";y_{#phi};Counts", 200, 0.0, 2.0},"y_phi_meas","accidweight");
            ...
            TH1D hist_phi_theta_com_kin                     = *rdf.Histo1D({("phi_theta_com_kin_"+ label).c_str(), ";#theta_{CM} (deg);Counts", 180, 0.0, 180.0},"phi_theta_com_kin","accidweight");
            hist_phi_theta_com_kin.Write();
            TH2D hist_minust_phi_theta_com_kin              = *rdf.Histo2D({("minust_phi_theta_com_kin_"+ label).c_str(), ";-t (GeV^{2}/c^{2});#theta_{CM} (deg)", 20, 0.0, 2.0, 40, 0.0, 40.0},"minust_kin","phi_theta_com_kin","accidweight");
            hist_minust_phi_theta_com_kin.Write();
            ...
            TH1D hist_kp_costheta_helicity_kin              = *rdf.Histo1D({("kp_costheta_helicity_kin_"+ label).c_str(), ";cos(#theta_{helicity});Counts", 10, -1.0, 1.0},"kp_costheta_helicity_kin","accidweight");
            hist_kp_costheta_helicity_kin.Write();
            TH1D hist_kp_phi_helicity_kin                   = *rdf.Histo1D({("kp_phi_helicity_kin_"+ label).c_str(), ";#phi_{helicity} (deg);Counts", 9, -180.0, 180.0},"kp_phi_helicity_kin","accidweight");
            hist_kp_phi_helicity_kin.Write();
            ...
            if (reaction.find("sim") != string::npos)
            {
                ...
                TH1D hist_phi_theta_com_truth               = *rdf.Histo1D({("phi_theta_com_truth_"+ label).c_str(), ";#theta_{CM} (deg);Counts", 180, 0.0, 180.0},"phi_theta_com_truth");
                hist_phi_theta_com_truth.Write();
                TH2D hist_minust_phi_theta_com_truth        = *rdf.Histo2D({("minust_phi_theta_com_truth_"+ label).c_str(), ";-t (GeV^{2}/c^{2});#theta_{CM} (deg)", 30, 0.0, 3.0, 180, 0.0, 180.0},"minust_truth","phi_theta_com_truth");
                hist_minust_phi_theta_com_truth.Write();
                ...
                TH1D hist_kp_costheta_helicity_truth        = *rdf.Histo1D({("kp_costheta_helicity_truth_"+ label).c_str(), ";cos(#theta_{helicity});Counts", 10, -1.0, 1.0},"kp_costheta_helicity_truth");
                hist_kp_costheta_helicity_truth.Write();
                TH1D hist_kp_phi_helicity_truth             = *rdf.Histo1D({("kp_phi_helicity_truth_"+ label).c_str(), ";#phi_{helicity} (deg);Counts", 9, -180.0, 180.0},"kp_phi_helicity_truth");
                hist_kp_phi_helicity_truth.Write();
