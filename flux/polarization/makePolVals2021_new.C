...
void makePolVals2021_new(int userSet){
...
//   fitShow = 0;
  ...
  if (sp18Set == true || fa18Set == true || sp20Set == true || y21Set == true) {
    ...
    TH2D *hPhiCutVsRunAtEg5900; hFile1->GetObject("hPhiCutVsRunAtEg1",hPhiCutVsRunAtEg5900);

    TH2D *hPhiCutVsRunAtEg6100; hFile1->GetObject("hPhiCutVsRunAtEg2",hPhiCutVsRunAtEg6100);
    TH2D *hPhiCutVsRunAtEg6300; hFile1->GetObject("hPhiCutVsRunAtEg3",hPhiCutVsRunAtEg6300);
    TH2D *hPhiCutVsRunAtEg6500; hFile1->GetObject("hPhiCutVsRunAtEg4",hPhiCutVsRunAtEg6500);
    TH2D *hPhiCutVsRunAtEg6700; hFile1->GetObject("hPhiCutVsRunAtEg5",hPhiCutVsRunAtEg6700);
    TH2D *hPhiCutVsRunAtEg6900; hFile1->GetObject("hPhiCutVsRunAtEg6",hPhiCutVsRunAtEg6900);
    ...
    TH1D *hPol0   = new TH1D("hPol0","",25,5.8,10.8);   hPol0->Sumw2();
    TH1D *hPol45  = new TH1D("hPol45","",25,5.8,10.8);  hPol45->Sumw2();
    TH1D *hPol90  = new TH1D("hPol90","",25,5.8,10.8);  hPol90->Sumw2();
    TH1D *hPol135 = new TH1D("hPol135","",25,5.8,10.8); hPol135->Sumw2();
    ...
    sprintf(hString,"hPhiCut0AtEg5900");
    TH1D *hPhiCut0AtEg5900 = new TH1D(hString,"",nBy,yLow,yHigh); hPhiCut0AtEg5900->Sumw2();
    phi1D(hPhiCutVsRunAtEg5900,hMask2dE0,hPhiCut0AtEg5900,hString,fitFun,true);
    par1 = fitFun->GetParameter(1); err1 = fitFun->GetParError(1);
    hPol0->SetBinContent(index,fabs(par1)); 
    hPol0->SetBinError(index,err1);
    index++;

    sprintf(hString,"hPhiCut0AtEg6100");
    TH1D *hPhiCut0AtEg6100 = new TH1D(hString,"",nBy,yLow,yHigh); hPhiCut0AtEg6100->Sumw2();
    phi1D(hPhiCutVsRunAtEg6100,hMask2dE0,hPhiCut0AtEg6100,hString,fitFun,true);
    par1 = fitFun->GetParameter(1); err1 = fitFun->GetParError(1);
    hPol0->SetBinContent(index,fabs(par1)); 
    hPol0->SetBinError(index,err1);
    index++;
    sprintf(hString,"hPhiCut0AtEg6300");
    TH1D *hPhiCut0AtEg6300 = new TH1D(hString,"",nBy,yLow,yHigh); hPhiCut0AtEg6300->Sumw2();
    phi1D(hPhiCutVsRunAtEg6300,hMask2dE0,hPhiCut0AtEg6300,hString,fitFun,true);
    par1 = fitFun->GetParameter(1); err1 = fitFun->GetParError(1);
    hPol0->SetBinContent(index,fabs(par1)); 
    hPol0->SetBinError(index,err1);
    index++;
    sprintf(hString,"hPhiCut0AtEg6500");
    TH1D *hPhiCut0AtEg6500 = new TH1D(hString,"",nBy,yLow,yHigh); hPhiCut0AtEg6500->Sumw2();
    phi1D(hPhiCutVsRunAtEg6500,hMask2dE0,hPhiCut0AtEg6500,hString,fitFun,true);
    par1 = fitFun->GetParameter(1); err1 = fitFun->GetParError(1);
    hPol0->SetBinContent(index,fabs(par1)); 
    hPol0->SetBinError(index,err1);
    index++;
    sprintf(hString,"hPhiCut0AtEg6700");
    TH1D *hPhiCut0AtEg6700 = new TH1D(hString,"",nBy,yLow,yHigh); hPhiCut0AtEg6700->Sumw2();
    phi1D(hPhiCutVsRunAtEg6700,hMask2dE0,hPhiCut0AtEg6700,hString,fitFun,true);
    par1 = fitFun->GetParameter(1); err1 = fitFun->GetParError(1);
    hPol0->SetBinContent(index,fabs(par1)); 
    hPol0->SetBinError(index,err1);
    index++;
    sprintf(hString,"hPhiCut0AtEg6900");
    TH1D *hPhiCut0AtEg6900 = new TH1D(hString,"",nBy,yLow,yHigh); hPhiCut0AtEg6900->Sumw2();
    phi1D(hPhiCutVsRunAtEg6900,hMask2dE0,hPhiCut0AtEg6900,hString,fitFun,true);
    par1 = fitFun->GetParameter(1); err1 = fitFun->GetParError(1);
    hPol0->SetBinContent(index,fabs(par1)); 
    hPol0->SetBinError(index,err1);
    index++;
    ...
    sprintf(hString,"hPhiCut45AtEg5900");
    TH1D *hPhiCut45AtEg5900 = new TH1D(hString,"",nBy,yLow,yHigh); hPhiCut45AtEg5900->Sumw2();
    phi1D(hPhiCutVsRunAtEg5900,hMask2dE45,hPhiCut45AtEg5900,hString,fitFun,true);
    par1 = fitFun->GetParameter(1); err1 = fitFun->GetParError(1);
    hPol45->SetBinContent(index,fabs(par1)); 
    hPol45->SetBinError(index,err1);
    index++;

    sprintf(hString,"hPhiCut45AtEg6100");
    TH1D *hPhiCut45AtEg6100 = new TH1D(hString,"",nBy,yLow,yHigh); hPhiCut45AtEg6100->Sumw2();
    phi1D(hPhiCutVsRunAtEg6100,hMask2dE45,hPhiCut45AtEg6100,hString,fitFun,true);
    par1 = fitFun->GetParameter(1); err1 = fitFun->GetParError(1);
    hPol45->SetBinContent(index,fabs(par1)); 
    hPol45->SetBinError(index,err1);
    index++;
    sprintf(hString,"hPhiCut45AtEg6300");
    TH1D *hPhiCut45AtEg6300 = new TH1D(hString,"",nBy,yLow,yHigh); hPhiCut45AtEg6300->Sumw2();
    phi1D(hPhiCutVsRunAtEg6300,hMask2dE45,hPhiCut45AtEg6300,hString,fitFun,true);
    par1 = fitFun->GetParameter(1); err1 = fitFun->GetParError(1);
    hPol45->SetBinContent(index,fabs(par1)); 
    hPol45->SetBinError(index,err1);
    index++;
    sprintf(hString,"hPhiCut45AtEg6500");
    TH1D *hPhiCut45AtEg6500 = new TH1D(hString,"",nBy,yLow,yHigh); hPhiCut45AtEg6500->Sumw2();
    phi1D(hPhiCutVsRunAtEg6500,hMask2dE45,hPhiCut45AtEg6500,hString,fitFun,true);
    par1 = fitFun->GetParameter(1); err1 = fitFun->GetParError(1);
    hPol45->SetBinContent(index,fabs(par1)); 
    hPol45->SetBinError(index,err1);
    index++;
    sprintf(hString,"hPhiCut45AtEg6700");
    TH1D *hPhiCut45AtEg6700 = new TH1D(hString,"",nBy,yLow,yHigh); hPhiCut45AtEg6700->Sumw2();
    phi1D(hPhiCutVsRunAtEg6700,hMask2dE45,hPhiCut45AtEg6700,hString,fitFun,true);
    par1 = fitFun->GetParameter(1); err1 = fitFun->GetParError(1);
    hPol45->SetBinContent(index,fabs(par1)); 
    hPol45->SetBinError(index,err1);
    index++;
    sprintf(hString,"hPhiCut45AtEg6900");
    TH1D *hPhiCut45AtEg6900 = new TH1D(hString,"",nBy,yLow,yHigh); hPhiCut45AtEg6900->Sumw2();
    phi1D(hPhiCutVsRunAtEg6900,hMask2dE45,hPhiCut45AtEg6900,hString,fitFun,true);
    par1 = fitFun->GetParameter(1); err1 = fitFun->GetParError(1);
    hPol45->SetBinContent(index,fabs(par1)); 
    hPol45->SetBinError(index,err1);
    index++;
    ...
    index = 1;
        sprintf(hString,"hPhiCut90AtEg5900");
    TH1D *hPhiCut90AtEg5900 = new TH1D(hString,"",nBy,yLow,yHigh); hPhiCut90AtEg5900->Sumw2();
    phi1D(hPhiCutVsRunAtEg5900,hMask2dE90,hPhiCut90AtEg5900,hString,fitFun,true);
    par1 = fitFun->GetParameter(1); err1 = fitFun->GetParError(1);
    hPol90->SetBinContent(index,fabs(par1)); 
    hPol90->SetBinError(index,err1);
    index++;

    sprintf(hString,"hPhiCut90AtEg6100");
    TH1D *hPhiCut90AtEg6100 = new TH1D(hString,"",nBy,yLow,yHigh); hPhiCut90AtEg6100->Sumw2();
    phi1D(hPhiCutVsRunAtEg6100,hMask2dE90,hPhiCut90AtEg6100,hString,fitFun,true);
    par1 = fitFun->GetParameter(1); err1 = fitFun->GetParError(1);
    hPol90->SetBinContent(index,fabs(par1)); 
    hPol90->SetBinError(index,err1);
    index++;
    sprintf(hString,"hPhiCut90AtEg6300");
    TH1D *hPhiCut90AtEg6300 = new TH1D(hString,"",nBy,yLow,yHigh); hPhiCut90AtEg6300->Sumw2();
    phi1D(hPhiCutVsRunAtEg6300,hMask2dE90,hPhiCut90AtEg6300,hString,fitFun,true);
    par1 = fitFun->GetParameter(1); err1 = fitFun->GetParError(1);
    hPol90->SetBinContent(index,fabs(par1)); 
    hPol90->SetBinError(index,err1);
    index++;
    sprintf(hString,"hPhiCut90AtEg6500");
    TH1D *hPhiCut90AtEg6500 = new TH1D(hString,"",nBy,yLow,yHigh); hPhiCut90AtEg6500->Sumw2();
    phi1D(hPhiCutVsRunAtEg6500,hMask2dE90,hPhiCut90AtEg6500,hString,fitFun,true);
    par1 = fitFun->GetParameter(1); err1 = fitFun->GetParError(1);
    hPol90->SetBinContent(index,fabs(par1)); 
    hPol90->SetBinError(index,err1);
    index++;
    sprintf(hString,"hPhiCut90AtEg6700");
    TH1D *hPhiCut90AtEg6700 = new TH1D(hString,"",nBy,yLow,yHigh); hPhiCut90AtEg6700->Sumw2();
    phi1D(hPhiCutVsRunAtEg6700,hMask2dE90,hPhiCut90AtEg6700,hString,fitFun,true);
    par1 = fitFun->GetParameter(1); err1 = fitFun->GetParError(1);
    hPol90->SetBinContent(index,fabs(par1)); 
    hPol90->SetBinError(index,err1);
    index++;
    sprintf(hString,"hPhiCut90AtEg6900");
    TH1D *hPhiCut90AtEg6900 = new TH1D(hString,"",nBy,yLow,yHigh); hPhiCut90AtEg6900->Sumw2();
    phi1D(hPhiCutVsRunAtEg6900,hMask2dE90,hPhiCut90AtEg6900,hString,fitFun,true);
    par1 = fitFun->GetParameter(1); err1 = fitFun->GetParError(1);
    hPol90->SetBinContent(index,fabs(par1)); 
    hPol90->SetBinError(index,err1);
    index++;
    ...
    sprintf(hString,"hPhiCut135AtEg5900");
    TH1D *hPhiCut135AtEg5900 = new TH1D(hString,"",nBy,yLow,yHigh); hPhiCut135AtEg5900->Sumw2();
    phi1D(hPhiCutVsRunAtEg5900,hMask2dE135,hPhiCut135AtEg5900,hString,fitFun,true);
    par1 = fitFun->GetParameter(1); err1 = fitFun->GetParError(1);
    hPol135->SetBinContent(index,fabs(par1)); 
    hPol135->SetBinError(index,err1);
    index++;

    sprintf(hString,"hPhiCut135AtEg6100");
    TH1D *hPhiCut135AtEg6100 = new TH1D(hString,"",nBy,yLow,yHigh); hPhiCut135AtEg6100->Sumw2();
    phi1D(hPhiCutVsRunAtEg6100,hMask2dE135,hPhiCut135AtEg6100,hString,fitFun,true);
    par1 = fitFun->GetParameter(1); err1 = fitFun->GetParError(1);
    hPol135->SetBinContent(index,fabs(par1)); 
    hPol135->SetBinError(index,err1);
    index++;
    sprintf(hString,"hPhiCut135AtEg6300");
    TH1D *hPhiCut135AtEg6300 = new TH1D(hString,"",nBy,yLow,yHigh); hPhiCut135AtEg6300->Sumw2();
    phi1D(hPhiCutVsRunAtEg6300,hMask2dE135,hPhiCut135AtEg6300,hString,fitFun,true);
    par1 = fitFun->GetParameter(1); err1 = fitFun->GetParError(1);
    hPol135->SetBinContent(index,fabs(par1)); 
    hPol135->SetBinError(index,err1);
    index++;
    sprintf(hString,"hPhiCut135AtEg6500");
    TH1D *hPhiCut135AtEg6500 = new TH1D(hString,"",nBy,yLow,yHigh); hPhiCut135AtEg6500->Sumw2();
    phi1D(hPhiCutVsRunAtEg6500,hMask2dE135,hPhiCut135AtEg6500,hString,fitFun,true);
    par1 = fitFun->GetParameter(1); err1 = fitFun->GetParError(1);
    hPol135->SetBinContent(index,fabs(par1)); 
    hPol135->SetBinError(index,err1);
    index++;
    sprintf(hString,"hPhiCut135AtEg6700");
    TH1D *hPhiCut135AtEg6700 = new TH1D(hString,"",nBy,yLow,yHigh); hPhiCut135AtEg6700->Sumw2();
    phi1D(hPhiCutVsRunAtEg6700,hMask2dE135,hPhiCut135AtEg6700,hString,fitFun,true);
    par1 = fitFun->GetParameter(1); err1 = fitFun->GetParError(1);
    hPol135->SetBinContent(index,fabs(par1)); 
    hPol135->SetBinError(index,err1);
    index++;
    sprintf(hString,"hPhiCut135AtEg6900");
    TH1D *hPhiCut135AtEg6900 = new TH1D(hString,"",nBy,yLow,yHigh); hPhiCut135AtEg6900->Sumw2();
    phi1D(hPhiCutVsRunAtEg6900,hMask2dE135,hPhiCut135AtEg6900,hString,fitFun,true);
    par1 = fitFun->GetParameter(1); err1 = fitFun->GetParError(1);
    hPol135->SetBinContent(index,fabs(par1)); 
    hPol135->SetBinError(index,err1);
    index++;
