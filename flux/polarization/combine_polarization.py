...
pdf = PdfPages('outFiles/polarization_plots.pdf')
...
plt.text(6.8, avg_polarization_one+0.02, f"{avg_polarization_one:.3f} ± {avg_polarization_one_err:.3f}", ha="center", va="bottom", fontsize=8, color="red")
plt.errorbar(8.3, avg_polarization_two, yerr=avg_polarization_two_err, xerr = 0.5, marker="o", markersize=5, color="blue")
plt.text(8.3, avg_polarization_two-0.02, f"{avg_polarization_two:.3f} ± {avg_polarization_two_err:.3f}", ha="center", va="bottom", fontsize=8, color="blue")
plt.errorbar(9.8, avg_polarization_three, yerr=avg_polarization_three_err, xerr = 1.0, marker="o", markersize=5, color="green")
plt.text(9.8, avg_polarization_three+0.01, f"{avg_polarization_three:.3f} ± {avg_polarization_three_err:.3f}", ha="center", va="bottom", fontsize=8, color="green")
...
all_combined_polarization[0] = 0
all_combined_error[0] = 0

file_txt = open("outFiles/polarization_table.txt", "w")
for i in range(len(all_combined_x)):
    file_txt.write(f"{all_combined_x[i]-0.1:5.2f} {all_combined_x[i]+0.1:5.2f} {all_combined_polarization[i]:.4f} {all_combined_error[i]:.4f}\n")
file_txt.close()