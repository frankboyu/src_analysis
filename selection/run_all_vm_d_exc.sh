...
sh run_local.sh     'phi_d_recon'   '/work/halld2/home/boyu/src_analysis/sim/output/phi_d_2H_ver12_03/root/tree_gd_kpkmd__B5_F4_gen_coherent/*.root'     'gd_kpkmd__B5_F4_Tree'
sh run_rename.sh    'phi_d_recon'   'exc_sim_2H' 'ver12_updated'
...
hadd output/selectedtree_phi_d_thrown.root  /work/halld2/home/boyu/src_analysis/sim/output/phi_d_2H_ver12_03/root/generator/*.root
sh run_rename.sh    'phi_d_thrown'  '' 'gen_2H_ver12_updated'
...
sh run_local.sh     'phi_d_thrown'  '/work/halld2/home/boyu/src_analysis/sim/output/phi_d_2H_ver12_03/root/thrown/*.root'  'Thrown_Tree'
sh run_rename.sh    'phi_d_thrown'  '' 'tagged_2H_ver12_updated'
