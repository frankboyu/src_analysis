...
if [ "$MODE" == "run" ]; then
    ...
    # sh run_local.sh     'rho_d_recon' '/work/halld2/home/boyu/src_analysis/sim/output/rho_d_2H_ver01/root/tree_gd_pippim__B4_F4_gen_coherent/*.root'            'gd_pippim__B4_F4_Tree'
    # sh run_local.sh     'rho_d_recon' '/work/halld2/home/boyu/src_analysis/sim/output/rho_d_2H_ver01/root/tree_gd_pippiminc__B4_F4_gen_coherent/*.root'         'gd_pippiminc__B4_F4_Tree'
    # sh run_local.sh     'rho_d_recon' '/work/halld2/home/boyu/src_analysis/sim/output/rho_d_4He_ver01/root/tree_ghe_pippimmissd__B4_F4_gen_coherent/*.root'     'ghe_pippimmissd__B4_F4_Tree'
    # sh run_local.sh     'rho_d_recon' '/work/halld2/home/boyu/src_analysis/sim/output/rho_d_4He_ver01/root/tree_ghe_pippiminc__B4_F4_gen_coherent/*.root'       'ghe_pippiminc__B4_F4_Tree'
    # sh run_local.sh     'rho_d_recon' '/work/halld2/home/boyu/src_analysis/sim/output/rho_d_12C_ver01/root/tree_gc12_pippimmissb10__B4_F4_gen_coherent/*.root'  'gc12_pippimmissb10__B4_F4_Tree'
    # sh run_local.sh     'rho_d_recon' '/work/halld2/home/boyu/src_analysis/sim/output/rho_d_12C_ver01/root/tree_gc12_pippiminc__B4_F4_gen_coherent/*.root'      'gc12_pippiminc__B4_F4_Tree'
