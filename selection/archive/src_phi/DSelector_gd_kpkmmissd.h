#ifndef DSelector_gd_kpkmmissd_h
#define DSelector_gd_kpkmmissd_h
...
class DSelector_gd_kpkmmissd : public DSelector
{
	public:

		DSelector_gd_kpkmmissd(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_gd_kpkmmissd(){}
	...
	private:
		...
		DKinematicData* dMissingDeuteronWrapper;
        ...
        TH2F* dHist_MissingDeuteronPVsTheta_Measured_After;
        TH2F* dHist_MissingDeuteronPVsTheta_KinFit_After;

	ClassDef(DSelector_gd_kpkmmissd, 0);
};

void DSelector_gd_kpkmmissd::Get_ComboWrappers(void)
{
	...
	dMissingDeuteronWrapper = dStep0Wrapper->Get_FinalParticle(2);
}

#endif // DSelector_gd_kpkmmissd_h
