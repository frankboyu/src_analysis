#include "DSelector_gd_kpkmnmissprot.h"
#include <TEnv.h>

double RadToDeg = 180.0/3.1415926;
double mass_proton = 0.938272;

void DSelector_gd_kpkmnmissprot::Init(TTree *locTree){
    
	//SET OUTPUT FILE NAME AND FORMAT
	dOutputFileName = "hist_gd_kpkmnmissprot.root"; //"" for none
	dOutputTreeFileName = ""; //"" for none
	dFlatTreeFileName = "flat_gd_kpkmnmissprot.root"; //output flat tree (one combo per tree entry), "" for none
    ...
    dHist_NeutronPVsTheta_Measured_Before           = new TH2F("ProtonPVsTheta_Measured_Before", ";Momentum (GeV);Theta (deg)", 1000, 0.0, 10.0, 180, 0.0, 180.0);
    dHist_NeutronPVsTheta_KinFit_Before             = new TH2F("ProtonPVsTheta_KinFit_Before", ";Momentum (GeV);Theta (deg)", 1000, 0.0, 10.0, 180, 0.0, 180.0);
    //Undetected particles
    dHist_MissingProtonPVsTheta_Measured_Before   = new TH2F("MissingNeutronPVsTheta_Measured_Before", ";Momentum (GeV);Theta (deg)", 1000, 0.0, 10.0, 180, 0.0, 180.0);
    dHist_MissingProtonPVsTheta_KinFit_Before     = new TH2F("MissingNeutronPVsTheta_KinFit_Before", ";Momentum (GeV);Theta (deg)", 1000, 0.0, 10.0, 180, 0.0, 180.0);    
    dHist_InitialNeutronPVsTheta_Measured_Before    = new TH2F("InitialProtonPVsTheta_Measured_Before", ";Momentum (GeV);Theta (deg)", 1000, 0.0, 10.0, 180, 0.0, 180.0);
    dHist_InitialNeutronPVsTheta_KinFit_Before      = new TH2F("InitialProtonPVsTheta_KinFit_Before", ";Momentum (GeV);Theta (deg)", 1000, 0.0, 10.0, 180, 0.0, 180.0);    
    ...
    dHist_NeutronPVsTheta_Measured_After           = new TH2F("ProtonPVsTheta_Measured_After", ";Momentum (GeV);Theta (deg)", 1000, 0.0, 10.0, 180, 0.0, 180.0);
    dHist_NeutronPVsTheta_KinFit_After             = new TH2F("ProtonPVsTheta_KinFit_After", ";Momentum (GeV);Theta (deg)", 1000, 0.0, 10.0, 180, 0.0, 180.0);
    //Undetected particles
    dHist_MissingProtonPVsTheta_Measured_After     = new TH2F("MissingNeutronPVsTheta_Measured_After", ";Momentum (GeV);Theta (deg)", 1000, 0.0, 10.0, 180, 0.0, 180.0);
    dHist_MissingProtonPVsTheta_KinFit_After       = new TH2F("MissingNeutronPVsTheta_KinFit_After", ";Momentum (GeV);Theta (deg)", 1000, 0.0, 10.0, 180, 0.0, 180.0);    
    dHist_InitialNeutronPVsTheta_Measured_After    = new TH2F("InitialProtonPVsTheta_Measured_After", ";Momentum (GeV);Theta (deg)", 1000, 0.0, 10.0, 180, 0.0, 180.0);
    dHist_InitialNeutronPVsTheta_KinFit_After      = new TH2F("InitialProtonPVsTheta_KinFit_After", ";Momentum (GeV);Theta (deg)", 1000, 0.0, 10.0, 180, 0.0, 180.0);    
    ...
    dHist_NeutronPVsTheta_Measured_Weighted        = new TH2F("ProtonPVsTheta_Measured_Weighted", ";Momentum (GeV);Theta (deg)", 1000, 0.0, 10.0, 180, 0.0, 180.0);
    dHist_NeutronPVsTheta_KinFit_Weighted          = new TH2F("ProtonPVsTheta_KinFit_Weighted", ";Momentum (GeV);Theta (deg)", 1000, 0.0, 10.0, 180, 0.0, 180.0);
    //Undetected particles
    dHist_MissingProtonPVsTheta_Measured_Weighted  = new TH2F("MissingNeutronPVsTheta_Measured_Weighted", ";Momentum (GeV);Theta (deg)", 1000, 0.0, 10.0, 180, 0.0, 180.0);
    dHist_MissingProtonPVsTheta_KinFit_Weighted    = new TH2F("MissingNeutronPVsTheta_KinFit_Weighted", ";Momentum (GeV);Theta (deg)", 1000, 0.0, 10.0, 180, 0.0, 180.0);    
    dHist_InitialNeutronPVsTheta_Measured_Weighted = new TH2F("InitialProtonPVsTheta_Measured_Weighted", ";Momentum (GeV);Theta (deg)", 1000, 0.0, 10.0, 180, 0.0, 180.0);
    dHist_InitialNeutronPVsTheta_KinFit_Weighted   = new TH2F("InitialProtonPVsTheta_KinFit_Weighted", ";Momentum (GeV);Theta (deg)", 1000, 0.0, 10.0, 180, 0.0, 180.0);    
...
Bool_t DSelector_gd_kpkmnmissprot::Process(Long64_t locEntry){
	...
	for(UInt_t loc_i = 0; loc_i < Get_NumCombos(); ++loc_i){
		...
		Int_t locNeutronNeutralID = dNeutronWrapper->Get_NeutralID();      
		...
		TLorentzVector locNeutronP4                 = dNeutronWrapper->Get_P4();
        TLorentzVector locMissingProtonP4           = locBeamP4 + dTargetP4 - locKPlusP4 - locKMinusP4 - locNeutronP4;
        TLorentzVector locInitialNeutronP4          = locKPlusP4 + locKMinusP4 + locNeutronP4 - locBeamP4;
        //Measured P4's:
		...
		TLorentzVector locNeutronP4_Measured        = dNeutronWrapper->Get_P4_Measured();
        TLorentzVector locMissingProtonP4_Measured  = locBeamP4_Measured + dTargetP4 - locKPlusP4_Measured - locKMinusP4_Measured - locNeutronP4_Measured;
        TLorentzVector locInitialNeutronP4_Measured = locKPlusP4 + locKMinusP4 + locNeutronP4 - locBeamP4;
		...
		double locMissingMassSquared_Measured = (locBeamP4_Measured + dTargetP4 - locKPlusP4_Measured - locKMinusP4_Measured - locNeutronP4_Measured).M2();
        double locMissingMassSquared_KinFit   = (locBeamP4 + dTargetP4 - locKPlusP4 - locKMinusP4 - locNeutronP4).M2();
        double locEnergyBalance_Measured      = (locKPlusP4_Measured + locKMinusP4_Measured + locNeutronP4_Measured).E() - locBeamP4_Measured.E() - mass_proton;
        double locEnergyBalance_KinFit        = (locKPlusP4 + locKMinusP4 + locNeutronP4).E() - locBeamP4.E() - mass_proton;   
        ...
        double locMinusU_Measured             = -(locBeamP4_Measured - locNeutronP4_Measured).Mag2();
        double locMinusU                      = -(locBeamP4 - locNeutronP4).Mag2();
        double locCoplanarityAngle_Measured   = abs((locKPlusP4_Measured + locKMinusP4_Measured).Phi() - locNeutronP4_Measured.Phi())*RadToDeg;        
        double locCoplanarityAngle_KinFit     = abs((locKPlusP4 + locKMinusP4).Phi() - locNeutronP4.Phi())*RadToDeg;
        ...
        dHist_NeutronPVsTheta_Measured_Before->Fill(locNeutronP4_Measured.P(), locNeutronP4_Measured.Theta()*RadToDeg, locHistAccidWeightFactor);    
        dHist_NeutronPVsTheta_KinFit_Before->Fill(locNeutronP4.P(), locNeutronP4.Theta()*RadToDeg, locHistAccidWeightFactor);
        ...
        if((locMissingMassSquared_Measured < 0.6) || (locMissingMassSquared_Measured > 1.2)){
			dComboWrapper->Set_IsComboCut(true);
			continue;}
        ...
        //Invariant mass cut
        if((locInvariantMass_Measured < 0.90) || (locInvariantMass_Measured > 1.10)){
			dComboWrapper->Set_IsComboCut(true);
			continue;}  
        ...
        dHist_NeutronPVsTheta_Measured_After->Fill(locNeutronP4_Measured.P(), locNeutronP4_Measured.Theta()*RadToDeg, locHistAccidWeightFactor);    
        dHist_NeutronPVsTheta_KinFit_After->Fill(locNeutronP4.P(), locNeutronP4.Theta()*RadToDeg, locHistAccidWeightFactor); 
		...
		Fill_FlatTree();}  //end of combo loop
...
void DSelector_gd_kpkmnmissprot::Finalize(void){
	//CALL THIS LAST
