...
void test_selector()
{
    ...
    //chain->Add("/cache/halld/RunPeriod-2021-11/analysis/ver03/tree_gd_kpkmprotmissn__B4_F4_T2_S5/merged/*.root");
    ...
    //chain->Process("DSelector_piminus_p_2H_recon.C+","");
    chain->Process("DSelector_piminus_p_2H_thrown.C+","");
