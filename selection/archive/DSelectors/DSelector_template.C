#include "DSelector_template.h"

void DSelector_template::Init(TTree *locTree)
{
	...
	dOutputFileName = "template.root"; //"" for none
...
Bool_t DSelector_template::Process(Long64_t locEntry)
{
	...
	*/
	...
	for(UInt_t loc_i = 0; loc_i < Get_NumCombos(); ++loc_i)
	{
		...
		locMissingP4_Measured -= locPiMinusP4_Measured + locProtonP4_Measured;
...
void DSelector_template::Finalize(void)
{
