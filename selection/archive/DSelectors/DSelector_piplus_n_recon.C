...
class DSelector_piplus_n_recon : public DSelector
{
	public:

		DSelector_piplus_n_recon(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_piplus_n_recon(){}
	...
	ClassDef(DSelector_piplus_n_recon, 0);
};

void DSelector_piplus_n_recon::Get_ComboWrappers(void)
{
	//Step 0
	dStep0Wrapper = dComboWrapper->Get_ParticleComboStep(0);
	dComboBeamWrapper = static_cast<DBeamParticle*>(dStep0Wrapper->Get_InitialParticle());
	dPiPlusWrapper = static_cast<DChargedTrackHypothesis*>(dStep0Wrapper->Get_FinalParticle(0));
	dNeutronWrapper = static_cast<DNeutralParticleHypothesis*>(dStep0Wrapper->Get_FinalParticle(1));
	dMissingNeutronWrapper = dStep0Wrapper->Get_FinalParticle(2);
}

void DSelector_piplus_n_recon::Init(TTree *locTree)
{
...
Bool_t DSelector_piplus_n_recon::Process(Long64_t locEntry)
{
	...
	*/
	...
	for(const auto& loc_combo : loc_combos)
	{
		...
		locMissingP4_Measured -= locPiPlusP4_Measured + locNeutronP4_Measured;
		...
		*/
		...
		locUsedThisCombo_MissingMass[Neutron].insert(locNeutronNeutralID);
...
void DSelector_piplus_n_recon::Finalize(void)
{
