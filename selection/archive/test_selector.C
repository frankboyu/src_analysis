...
void test_selector()
{
    ...
    //chain->Add("/cache/halld/RunPeriod-2021-11/analysis/ver06/tree_ghe_pimprotinc__B4_F4_T1_S4/merged/tree_ghe_pimprotinc__B4_F4_T1_S4_090061.root");
    //chain->Add("/cache/halld/RunPeriod-2021-11/analysis/ver03/tree_gd_pimprotmissprot__B4_F4_T1_S4/merged/*.root");
    chain->Add("/volatile/halld/home/boyu/src_analysis/sim/piminus_p_4He/temp/root/thrown/*.root");
    ...
    chain->Process("../selectors/DSelector_piminus_p_4He_thrown.C+","");
