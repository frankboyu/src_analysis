...
class DSelector_jpsi_d_recon : public DSelector
{
public:

    DSelector_jpsi_d_recon(TTree* locTree = NULL) : DSelector(locTree){}
    virtual ~DSelector_jpsi_d_recon(){}
...
private:
    ...
    ClassDef(DSelector_jpsi_d_recon, 0);
};

void DSelector_jpsi_d_recon::Get_ComboWrappers(void)
{
...
void DSelector_jpsi_d_recon::Init(TTree *locTree)
{

    // SET OUTPUT FILE NAME
    dOutputFileName          = "selectedhist_jpsi_d_recon.root";
    dOutputTreeFileName      = "";
    dFlatTreeFileName        = "";
    dFlatTreeName            = "";
...
Bool_t DSelector_jpsi_d_recon::Process(Long64_t locEntry)
{
	// CALL THIS FIRST
...
void DSelector_jpsi_d_recon::Finalize(void)
{
	// CALL THIS LAST
