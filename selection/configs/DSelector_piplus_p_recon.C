...
class DSelector_piplus_p_recon : public DSelector
{
public:

    DSelector_piplus_p_recon(TTree* locTree = NULL) : DSelector(locTree){}
    virtual ~DSelector_piplus_p_recon(){}
...
private:
    ...
    ClassDef(DSelector_piplus_p_recon, 0);
};

void DSelector_piplus_p_recon::Get_ComboWrappers(void)
{
...
void DSelector_piplus_p_recon::Init(TTree *locTree)
{
    // DETERMINE THE TAG NAME
    if      (locTree->GetBranch("MCWeight") == NULL && strstr(locTree->GetName(), "bggen") == NULL && !strncmp(locTree->GetName(), "gd_pipprotmissprot",   strlen("gd_pipprotmissprot")))
        dTag = "data_2H_missprot";
    else if (locTree->GetBranch("MCWeight") == NULL && strstr(locTree->GetName(), "bggen") == NULL && !strncmp(locTree->GetName(), "gd_pipprotinc",        strlen("gd_pipprotinc")))
        dTag = "data_2H_inc";
    else if (locTree->GetBranch("MCWeight") == NULL && strstr(locTree->GetName(), "bggen") == NULL && !strncmp(locTree->GetName(), "ghe_pipprotmisshe3",   strlen("ghe_pipprotmisshe3")))
        dTag = "data_4He_misshe3";
    else if (locTree->GetBranch("MCWeight") == NULL && strstr(locTree->GetName(), "bggen") == NULL && !strncmp(locTree->GetName(), "ghe_pipprotinc",       strlen("ghe_pipprotinc")))
        dTag = "data_4He_inc";
    else if (locTree->GetBranch("MCWeight") == NULL && strstr(locTree->GetName(), "bggen") == NULL && !strncmp(locTree->GetName(), "gc12_pipprotmissb11",  strlen("gc12_pipprotmissb11")))
        dTag = "data_12C_missb11";
    else if (locTree->GetBranch("MCWeight") == NULL && strstr(locTree->GetName(), "bggen") == NULL && !strncmp(locTree->GetName(), "gc12_pipprotinc",      strlen("gc12_pipprotinc")))
        dTag = "data_12C_inc";
    else if (locTree->GetBranch("MCWeight") != NULL && strstr(locTree->GetName(), "bggen") == NULL && !strncmp(locTree->GetName(), "gd_pipprotmissprot",   strlen("gd_pipprotmissprot")))
    ...
    dOutputFileName          = Form("selectedhist_piplus_p_recon_%s.root", dTag.c_str());
    dOutputTreeFileName      = "";
    dFlatTreeFileName        = Form("selectedtree_piplus_p_recon_%s.root", dTag.c_str());
    dFlatTreeName            = "selectedtree_piplus_p_recon";
...
Bool_t DSelector_piplus_p_recon::Process(Long64_t locEntry)
{
	// CALL THIS FIRST
...
void DSelector_piplus_p_recon::Finalize(void)
{
	// CALL THIS LAST
