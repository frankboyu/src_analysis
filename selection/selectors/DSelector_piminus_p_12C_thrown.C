...
class DSelector_piminus_p_12C_thrown : public DSelector
{
	public:

		DSelector_piminus_p_12C_thrown(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_piminus_p_12C_thrown(){}
	...
	ClassDef(DSelector_piminus_p_12C_thrown, 0);
};

void DSelector_piminus_p_12C_thrown::Init(TTree *locTree)
{
    // SET OUTPUT FILE NAME 
    dOutputFileName          = "";
    dOutputTreeFileName      = "";
    dFlatTreeFileName        = "flattree_piminus_p_12C_thrown.root";
    dFlatTreeName            = "flattree_piminus_p_12C_thrown";
...
Bool_t DSelector_piminus_p_12C_thrown::Process(Long64_t locEntry)
{
	//CALL THIS FIRST
...
void DSelector_piminus_p_12C_thrown::Finalize(void)
{
	//CALL THIS LAST
