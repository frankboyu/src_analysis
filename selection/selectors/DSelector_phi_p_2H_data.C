...
double mass_proton  = 0.938272089;
double mass_neutron = 0.939565421;

class DSelector_phi_p_2H_data : public DSelector
{
	public:

		DSelector_phi_p_2H_data(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_phi_p_2H_data(){}
	...
	ClassDef(DSelector_phi_p_2H_data, 0);
};

void DSelector_phi_p_2H_data::Get_ComboWrappers(void)
{
...
void DSelector_phi_p_2H_data::Init(TTree *locTree)
{
	// SET OUTPUT FILE NAME
	dOutputFileName          = "";
	dOutputTreeFileName      = "";
	dFlatTreeFileName        = "flattree_phi_p_2H_data.root";
	dFlatTreeName            = "flattree_phi_p_2H_data";
...
Bool_t DSelector_phi_p_2H_data::Process(Long64_t locEntry)
{
	// CALL THIS FIRST
	...
	for(UInt_t loc_i = 0; loc_i < Get_NumCombos(); ++loc_i)
	{
        ...
        dHist_EnergyBalance_Before    ->Fill(mass_proton-locMissingP4.E(),                                                 locHistAccidWeightFactor);
...
void DSelector_phi_p_2H_data::Finalize(void)
{
	// CALL THIS LAST
