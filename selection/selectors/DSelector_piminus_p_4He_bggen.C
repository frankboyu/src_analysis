...
class DSelector_piminus_p_4He_bggen : public DSelector
{
	public:

		DSelector_piminus_p_4He_bggen(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_piminus_p_4He_bggen(){}
	...
	ClassDef(DSelector_piminus_p_4He_bggen, 0);
};

void DSelector_piminus_p_4He_bggen::Get_ComboWrappers(void)
{
...
void DSelector_piminus_p_4He_bggen::Init(TTree *locTree)
{
	// SET OUTPUT FILE NAME
	dOutputFileName          = "";
	dOutputTreeFileName      = "";
	dFlatTreeFileName        = "flattree_piminus_p_4He_bggen.root";
	dFlatTreeName            = "flattree_piminus_p_4He_bggen";
...
Bool_t DSelector_piminus_p_4He_bggen::Process(Long64_t locEntry)
{
	// CALL THIS FIRST
...
void DSelector_piminus_p_4He_bggen::Finalize(void)
{
