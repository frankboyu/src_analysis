...
class DSelector_piminus_p_4He_data : public DSelector
{
	public:

		DSelector_piminus_p_4He_data(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_piminus_p_4He_data(){}
	...
	ClassDef(DSelector_piminus_p_4He_data, 0);
};

void DSelector_piminus_p_4He_data::Get_ComboWrappers(void)
{
...
void DSelector_piminus_p_4He_data::Init(TTree *locTree)
{
	// SET OUTPUT FILE NAME
	dOutputFileName          = "";
	dOutputTreeFileName      = "";
	dFlatTreeFileName        = "flattree_piminus_p_4He_data.root";
	dFlatTreeName            = "flattree_piminus_p_4He_data";
...
Bool_t DSelector_piminus_p_4He_data::Process(Long64_t locEntry)
{
	// CALL THIS FIRST
...
void DSelector_piminus_p_4He_data::Finalize(void)
{
	// CALL THIS LAST
