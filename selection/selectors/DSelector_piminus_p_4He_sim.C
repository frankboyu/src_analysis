...
class DSelector_piminus_p_4He_sim : public DSelector
{
	public:

		DSelector_piminus_p_4He_sim(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_piminus_p_4He_sim(){}
	...
	ClassDef(DSelector_piminus_p_4He_sim, 0);
};

void DSelector_piminus_p_4He_sim::Get_ComboWrappers(void)
{
...
void DSelector_piminus_p_4He_sim::Init(TTree *locTree)
{
	// SET OUTPUT FILE NAME
	dOutputFileName          = "";
	dOutputTreeFileName      = "";
	dFlatTreeFileName        = "flattree_piminus_p_4He_sim.root";
	dFlatTreeName            = "flattree_piminus_p_4He_sim";
...
Bool_t DSelector_piminus_p_4He_sim::Process(Long64_t locEntry)
{
	// CALL THIS FIRST
...
void DSelector_piminus_p_4He_sim::Finalize(void)
{
	// CALL THIS LAST
