...
class DSelector_piminus_p_4He_thrown : public DSelector
{
	public:

		DSelector_piminus_p_4He_thrown(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_piminus_p_4He_thrown(){}
	...
	ClassDef(DSelector_piminus_p_4He_thrown, 0);
};
...
void DSelector_piminus_p_4He_thrown::Init(TTree *locTree)
{
    ...
    dFlatTreeName            = "flattree_piminus_p_4He_thrown";
...
Bool_t DSelector_piminus_p_4He_thrown::Process(Long64_t locEntry)
{
	//CALL THIS FIRST
...
void DSelector_piminus_p_4He_thrown::Finalize(void)
{
	//CALL THIS LAST
