#ifndef DSelector_piminus_p_4He_recon_h
#define DSelector_piminus_p_4He_recon_h
...
class DSelector_piminus_p_4He_recon : public DSelector
{
	public:
    
		DSelector_piminus_p_4He_recon(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_piminus_p_4He_recon(){}
	...
	ClassDef(DSelector_piminus_p_4He_recon, 0);
};

void DSelector_piminus_p_4He_recon::Get_ComboWrappers(void)
{
