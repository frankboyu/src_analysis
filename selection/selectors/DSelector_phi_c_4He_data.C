...
class DSelector_phi_c_4He_data : public DSelector
{
	public:

		DSelector_phi_c_4He_data(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_phi_c_4He_data(){}
	...
	ClassDef(DSelector_phi_c_4He_data, 0);
};

void DSelector_phi_c_4He_data::Get_ComboWrappers(void)
{
...
void DSelector_phi_c_4He_data::Init(TTree *locTree)
{
    ...
    dHist_MissingPMinus_Before         = new TH1F("MissingPMinus_Before",           ";P^{-}_{miss} (GeV)          ;Events/0.01 GeV",        200,  2.0,   4.0);
    dHist_MissingMassSquared_Before    = new TH1F("MissingMassSquared_Before",      ";M^{2}_{miss} (GeV^{2})      ;Events/0.05 GeV",        200,  0.0,  20.0);
    dHist_MissingMass_Before           = new TH1F("MissingMass_Before",             ";M_{miss} (GeV)              ;Events/0.02 GeV",        200,  2.0,   6.0);
    ...
    dHist_MissingPMinus_After          = new TH1F("MissingPMinus_After",       ";P^{-}_{miss} (GeV)          ;Events/0.01 GeV",        200,  2.0,   4.0);
    dHist_MissingMassSquared_After     = new TH1F("MissingMassSquared_After",  ";M^{2}_{miss} (GeV^{2})      ;Events/0.05 GeV",        200,  0.0,  20.0);
    dHist_MissingMass_After            = new TH1F("MissingMass_After",         ";M_{miss} (GeV)              ;Events/0.02 GeV",        200,  2.0,   6.0);
...
Bool_t DSelector_phi_c_4He_data::Process(Long64_t locEntry)
{
	// CALL THIS FIRST
	...
	for(UInt_t loc_i = 0; loc_i < Get_NumCombos(); ++loc_i)
	{
        ...
        TLorentzVector locTargetP4(0.0, 0.0, 0.0, mass_helium4);
        ...
        dHist_EnergyBalance_Before      ->Fill(mass_helium4-locMissingP4.E(),                                                locHistAccidWeightFactor);
...
void DSelector_phi_c_4He_data::Finalize(void)
{
	// CALL THIS LAST
