...
DATA_SOURCE_BASE_DIR="/cache/halld/offline_monitoring/RunPeriod-2021-11/ver02/REST"

DATA_OUTPUT_BASE_DIR="/work/halld2/home/boyu/src_phi_plugin/results/kinfit"

# JOB EXECUTION
SCRIPTFILE        = "/work/halld2/home/boyu/src_phi_plugin/script.sh" # location of the script file
ENVFILE           = "/work/halld2/home/boyu/src_phi_plugin/env.csh" # location of .cshrc
CONFIG_FILE_PATH  = "/work/halld2/home/boyu/src_phi_plugin/config.conf" # location of confid file for hd_root
TREE_NAMES        = "1p2k"

# CONFIG FILE CONTENTS
CONFIG_DICT = {}
CONFIG_DICT["PLUGINS"] =            "src_phi_plugin"
...
def add_job(WORKFLOW, DATA_SOURCE_DIR, FILENAME, RUNNO, FILENO):
	...
	# job
	add_command = "echo swif add-job -workflow " + WORKFLOW + " -name " + JOBNAME
	# project/track
	...
	# command
	add_command += " " + SCRIPTFILE + " " + ENVFILE + " " + DATA_SOURCE_DIR + "/" + FILENAME + " " + CONFIG_FILE_PATH + " " + DATA_OUTPUT_BASE_DIR + " " + RUNNO + " " + FILENO + " " + TREE_NAMES
