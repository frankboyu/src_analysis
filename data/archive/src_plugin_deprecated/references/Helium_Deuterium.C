...
//  TH1F *hRatio_HeD = new TH1F (*htrho_he);
  TH1F *hRatio_HeD = new TH1F("hRatio_HeD","|t|", 20, 0.1, 15);
  hRatio_HeD -> Divide(htrho_he, htrho_D,1.0,1.35);	  	
  //  TH1F *hRatiom_HeD = new TH1F (*htrhom_he);
  TH1F *hRatiom_HeD = new TH1F("hRatiom_HeD","|t|", 20, 0.1, 15);
  hRatiom_HeD -> Divide(htrhom_he, htrhom_D, 1.0/12902/1.24, 1.35/4788/2.08);	  	
	...
	// cHeD->cd(2);
       ...
       hRatiom_HeD->GetYaxis()->SetTitle("Ratio He/D");
