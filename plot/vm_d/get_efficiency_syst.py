...
file_pdf = PdfPages("/work/halld2/home/boyu/src_analysis/plot/vm_d/output/plots_vm_d_efficiency_syst.pdf")
...
plt.axes(axs[0])
plt.imshow(np.transpose(weights_kp_data),origin="lower",extent=[efficiency_kp.xedge[0],efficiency_kp.xedge[-1],efficiency_kp.yedge[0],efficiency_kp.yedge[-1]],aspect="auto", vmin = 0)
plt.title("K+ Data", fontsize=15)
plt.axes(axs[1])
plt.imshow(np.transpose(weights_km_data),origin="lower",extent=[efficiency_km.xedge[0],efficiency_km.xedge[-1],efficiency_km.yedge[0],efficiency_km.yedge[-1]],aspect="auto", vmin = 0)
plt.title("K- Data", fontsize=15)
plt.axes(axs[2])
plt.imshow(np.transpose(weights_kp_sim),origin="lower",extent=[efficiency_kp.xedge[0],efficiency_kp.xedge[-1],efficiency_kp.yedge[0],efficiency_kp.yedge[-1]],aspect="auto", vmin = 0)
plt.title("K+ Sim", fontsize=15)
plt.axes(axs[3])
plt.imshow(np.transpose(weights_km_sim),origin="lower",extent=[efficiency_km.xedge[0],efficiency_km.xedge[-1],efficiency_km.yedge[0],efficiency_km.yedge[-1]],aspect="auto", vmin = 0)
plt.title("K- Sim", fontsize=15)
...
file_eff_kp     = File("input/recon_efficiency_2017_ver03_misspip.root")
efficiency_kp   = file_eff_kp.get("EfficRatioMethod2_PVsTheta")
efficiency_kp.plotHeatmap(vmin=0.9,vmax=1.5)
...
file_eff_km     = File("input/recon_efficiency_2017_ver03_misspim.root")
efficiency_km   = file_eff_km.get("EfficRatioMethod2_PVsTheta")
efficiency_km.plotHeatmap(vmin=0.9,vmax=1.5)
plt.title("2017-01 ver03", fontsize=15)
