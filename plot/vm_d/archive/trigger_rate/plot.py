...
plt.bar(1,hist_gtp.y[0], align='center', alpha=0.7, ecolor='black', capsize=2, color='blue')
plt.bar(2,hist_gtp.y[1], align='center', alpha=0.7, ecolor='black', capsize=2, color='blue')
plt.bar(3,hist_gtp.y[3], align='center', alpha=0.7, ecolor='black', capsize=2, color='blue')
plt.bar(4,hist_fp.y[2], align='center', alpha=0.7, ecolor='black', capsize=2, color='blue')
plt.bar(5,hist_fp.y[8]+hist_fp.y[9], align='center', alpha=0.7, ecolor='black', capsize=2, color='blue')
plt.bar(6,hist_fp.y[11], align='center', alpha=0.7, ecolor='black', capsize=2, color='blue')
plt.xticks(np.arange(0, 7, 1), labels=["", "GTP Bit 1\nST+FCAL+BCAL","GTP Bit 2\nFCAL+BCAL","GTP Bit 4\nPS","FP Bit 3\nFCAL LED","FP Bit 9/10\nBCAL LED","FP Bit 12\nRANDOM"])
