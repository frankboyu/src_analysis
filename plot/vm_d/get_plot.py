...
plt.subplot(122)
plt.errorbar((phi_d_2H_Wcostheta_costheta_low[10:15]+phi_d_2H_Wcostheta_costheta_high[10:15])/2, phi_d_2H_Wcostheta_yield_data[10:15], yerr=np.sqrt(phi_d_2H_Wcostheta_yield_data[10:15]), fmt='.')
plt.xlabel(r'$\cos\theta_{H}$')
plt.ylabel(r'$Y(\cos\theta_{H})$')
...
plt.ylim(0, 0.1)
plt.subplot(122)
plt.errorbar((phi_d_2H_Wcostheta_costheta_low[10:15]+phi_d_2H_Wcostheta_costheta_high[10:15])/2, phi_d_2H_Wcostheta_acceptance[10:15], fmt='.')
plt.xlabel(r'$\cos\theta_{H}$')
plt.ylabel(r'$\epsilon(\cos\theta_{H})$')
plt.title(r'$0.8<-t<2.0\ \mathrm{GeV}^2$')
plt.ylim(0, 0.1)
