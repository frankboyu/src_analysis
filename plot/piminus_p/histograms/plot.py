...
file_data = File("/work/halld2/home/boyu/src_analysis/filter/output/test/filteredhist_piminus_p_recon_data_12C_missb11.root")
file_sim = File("/work/halld2/home/boyu/src_analysis/filter/output/test/filteredhist_piminus_p_recon_sim_12C_missb11.root")

hist_data = file_data.get('KinematicsCut/miss_pminus_KinematicsCut')
hist_sim = file_sim.get('KinematicsCut/miss_pminus_KinematicsCut')
hist_data.areaNorm(hist_sim)
# hist_data.scale(6)
hist_data.plotPoints(label="Data",color="black")
hist_sim.plotPoints(label="Sim",color="red")
plt.legend()
plt.savefig("missb11.png")
# print(file_data.getNames())